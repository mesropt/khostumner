...
| Анонимная эксплуатация сайта | Снижение юридического риска в условиях армянского законодательства о диффамации | — Pending |
| Статус = чистый краудсорсинг | >50% голосов при ≥25 голосах; иначе «Не оценено»; администраторы не устанавливают статус | — Pending |
| Администраторы могут сбрасывать голоса | Единственный инструмент борьбы с накруткой на уровне статуса | — Pending |
| Возраст аккаунта ≥30 дней для голосования | Защита от одноразовых аккаунтов при координированных атаках | — Pending |
