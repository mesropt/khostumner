  ...
  if (isLoading) {
    return (
      <main className="max-w-4xl mx-auto px-4 py-8">
        <h1 className="text-2xl font-semibold text-zinc-900 mb-6">Կատարված խոստումներ</h1>
  ...
  if (!data || data.items.length === 0) {
    return (
      <main className="max-w-4xl mx-auto px-4 py-8">
        <h1 className="text-2xl font-semibold text-zinc-900 mb-6">Կատարված խոստումներ</h1>
        <div className="flex flex-col items-center gap-4 py-16 text-center">
          <h2 className="text-lg font-semibold text-zinc-900">Կատարված խոստումներ դեռ չկան</h2>
          <p className="text-sm text-zinc-500">
            Կատարված խոստումները կհայտնվեն, երբ համայնքը կձայնաբերի
          </p>
        </div>
      </main>
    )
